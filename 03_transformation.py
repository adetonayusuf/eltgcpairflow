...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='global-health-bucket-data',  # Replace with your bucket name
        object='global-health-bucket-data/global_health_data.csv',  # Replace with the file path in the bucket
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='global-health-bucket-data',
        ...
        dataset_create=True,  # Create dataset if missing
)
